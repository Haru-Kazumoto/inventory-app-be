...
export class UpdateColumnTables1709995287972 implements MigrationInterface {
    name = 'UpdateColumnTables1709995287972'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "item_details" ("id" SERIAL NOT NULL, "item_id" integer NOT NULL, "category_item" character varying, "total_exit_item" integer DEFAULT '0', "exit_log_id" integer, CONSTRAINT "PK_5454cdc4a554db3678109d12533" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "redeem_code" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "id" SERIAL NOT NULL, "redeem_code" character varying(5) NOT NULL, "generated_date" TIMESTAMP NOT NULL, "is_valid" boolean NOT NULL DEFAULT true, "destroyed_date" TIMESTAMP, "log_id" integer NOT NULL, "exitLogId" integer, CONSTRAINT "UQ_ffbe7215c9e68c4cc828cdf6083" UNIQUE ("redeem_code"), CONSTRAINT "REL_a3c14218b397b4460fe73688c4" UNIQUE ("exitLogId"), CONSTRAINT "PK_59f77ecc8d36e06351d84313c93" PRIMARY KEY ("id"))`);
