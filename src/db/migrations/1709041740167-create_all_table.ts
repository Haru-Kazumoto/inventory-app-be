...
export class CreateAllTable1709041740167 implements MigrationInterface {
    name = 'CreateAllTable1709041740167'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "item_details" ("id" SERIAL NOT NULL, "item_id" integer NOT NULL, "exit_log_id" integer NOT NULL, "exitLogId" integer, CONSTRAINT "PK_5454cdc4a554db3678109d12533" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "exit_logs" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "phone" character varying NOT NULL, "major_class" character varying NOT NULL, "item_category" character varying NOT NULL DEFAULT 'Barang Habis Pakai', "item_detail_id" integer NOT NULL, "redeemCodeId" integer, CONSTRAINT "REL_095d77fb5c0604b0dffde283c7" UNIQUE ("redeemCodeId"), CONSTRAINT "PK_6d627a026f50b36a110afac0c9d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "item_details" ADD CONSTRAINT "FK_d89e60bcfc265816ec1c7577bde" FOREIGN KEY ("exitLogId") REFERENCES "exit_logs"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "item_details" DROP CONSTRAINT "FK_d89e60bcfc265816ec1c7577bde"`);
