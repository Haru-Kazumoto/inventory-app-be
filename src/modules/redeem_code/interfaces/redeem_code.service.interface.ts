...
export interface IRedeemCodeService {
    ...
    // updateRedeemCodeAndGenerate(redeemCode: string, body: UpdateExitLogDto): Promise<RedeemCode>;
    findByRedeemCode(redeemCode: string): Promise<RedeemCode>;
    generateRedeemCode(): string;
    findAllRedeemCodes(filterStatus: StatusCode,pageOptions: PageOptionsDto): Promise<PageDto<RedeemCode>>;
